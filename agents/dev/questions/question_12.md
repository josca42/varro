# Question 12: Sygefravær på tværs af brancher og kønsforskelle

Use question 12 from `agents/dev/test_plan.md` as a starter for exploring the varro agent using the playground-explorer skill in `.claude/skills/playground-explorer/SKILL.md`. For how to interpret the trajectory see `.claude/skills/analyse-trajectory/SKILL.md`.

## Opening question

> Hvilke brancher har det højeste sygefravær, og er der kønsforskelle?
