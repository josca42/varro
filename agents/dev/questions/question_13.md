# Question 13: Dashboard om turisme i Danmark

Use question 13 from `agents/dev/test_plan.md` as a starter for exploring the varro agent using the playground-explorer skill in `.claude/skills/playground-explorer/SKILL.md`. For how to interpret the trajectory see `.claude/skills/analyse-trajectory/SKILL.md`.

## Opening question

> Lav et dashboard om turisme i Danmark
