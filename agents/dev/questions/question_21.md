# Question 21: Kort over indkomstniveau i kommuner

Use question 21 from `agents/dev/test_plan.md` as a starter for exploring the varro agent using the playground-explorer skill in `.claude/skills/playground-explorer/SKILL.md`. For how to interpret the trajectory see `.claude/skills/analyse-trajectory/SKILL.md`.

## Opening question

> Vis et kort over indkomstniveauet i danske kommuner
