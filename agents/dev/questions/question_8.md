# Question 8: Jeg er nysgerrig på kriminalitet i Danmark — hvad viser tallene?

Use question 8 from `agents/dev/test_plan.md` as a starter for exploring the varro agent using the playground-explorer skill in `.claude/skills/playground-explorer/SKILL.md`. For how to interpret the trajectory see `.claude/skills/analyse-trajectory/SKILL.md`.
