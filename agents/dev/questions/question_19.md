# Question 19: Mid-conversation pivot from crime to youth unemployment

Use question 19 from `agents/dev/test_plan.md` as a starter for exploring the varro agent using the playground-explorer skill in `.claude/skills/playground-explorer/SKILL.md`. For how to interpret the trajectory see `.claude/skills/analyse-trajectory/SKILL.md`.

**Setup**: Start by exploring crime data (as in question 8), then pivot mid-conversation.

## Opening question

> Jeg er nysgerrig på kriminalitet i Danmark — hvad viser tallene?

## Follow-up pivot (after 1-2 turns of crime exploration)

> Vent — kan vi i stedet kigge på, om det hænger sammen med ungdomsarbejdsløshed?
