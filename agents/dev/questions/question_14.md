# Question 14: Dashboard over boligmarkedet (specific)

Use question 14 from `agents/dev/test_plan.md` as a starter for exploring the varro agent using the playground-explorer skill in `.claude/skills/playground-explorer/SKILL.md`. For how to interpret the trajectory see `.claude/skills/analyse-trajectory/SKILL.md`.

## Opening question

> Lav et dashboard over boligmarkedet med prisudvikling, boligbestand og salgsaktivitet, filtreret på region og ejendomstype
