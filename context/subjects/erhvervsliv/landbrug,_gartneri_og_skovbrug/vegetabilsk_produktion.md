...
- Map: halm1, hst77, vhus1, gartn1 support choropleth maps via context/geo/regioner.parquet (niveau 1) or context/geo/landsdele.parquet (niveau 2) — merge on omrade=dim_kode. Note only 5 of 11 landsdele are present (agricultural regions). Exclude omrade=0.