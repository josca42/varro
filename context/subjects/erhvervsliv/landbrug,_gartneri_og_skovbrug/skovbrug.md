...
- Map: skov11 and skov55 support choropleth maps at landsdel (niveau 2) and region (niveau 1) level via context/geo/landsdele.parquet and context/geo/regioner.parquet. skov55a and skov6 use only Jylland/Øerne codes — no geo join possible.