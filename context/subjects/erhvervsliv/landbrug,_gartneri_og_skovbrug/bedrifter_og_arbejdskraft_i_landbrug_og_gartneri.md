...
- Map: bdf11, bdf107, bdf207, bdf307, bdf807, bdf907 support choropleth at region level (context/geo/regioner.parquet) or 5-landsdel level (context/geo/landsdele.parquet) — merge on omrade=dim_kode, exclude omrade IN (0, 15). bdf51 supports kommune-level maps (context/geo/kommuner.parquet) — merge on omrade=dim_kode, exclude omrade=0.