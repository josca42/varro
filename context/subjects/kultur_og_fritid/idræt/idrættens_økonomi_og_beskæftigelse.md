...
- Map: idrfin01 (total spend) and idrfin02 (per-capita spend) support choropleth maps via context/geo/kommuner.parquet (niveau 3) or context/geo/landsdele.parquet (niveau 2).
