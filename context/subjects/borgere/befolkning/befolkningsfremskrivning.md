...
- Map: frkm125 and frkm225 support kommune-level choropleth via context/geo/kommuner.parquet (merge on kommunedk=dim_kode). frld125 supports region/landsdel via context/geo/regioner.parquet (niveau 1) or context/geo/landsdele.parquet (niveau 2) (merge on regland=dim_kode). frld225 uses context/geo/landsdele.parquet (merge on landsdel=dim_kode).