...
- **Map support:** kvres and valgk3 support choropleth at kommune (niveau 3) or region (niveau 1) via context/geo/kommuner.parquet / context/geo/regioner.parquet (merge on omrade=dim_kode). akva3 is region-level only. ligedb2 and ligedi2 support kommune, landsdel, and region via context/geo/kommuner.parquet / context/geo/landsdele.parquet / context/geo/regioner.parquet (merge on komk=dim_kode). Exclude code 0 in all cases.