...
- Map: context/geo/kommuner.parquet — filter omrade codes 101+, merge on CAST(omrade AS INT)=dim_kode. Or context/geo/regioner.parquet — filter omrade IN ('081','082','083','084','085'), merge on CAST(omrade AS INT)=dim_kode (strips leading zero). Exclude LAND and IKMAK.